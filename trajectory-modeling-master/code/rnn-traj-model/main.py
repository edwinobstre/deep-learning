...
class Config(object):
  ...
  dataset_name = "RUI" #e.g., 'porto_40k', 'porto_6k'
  dataset_path = None # do not set this manually
  workspace = '/data-RNN' # the true workspace will actually be workspace + '/' + dataset_name
  file_name = "drive.txt"
...
if __name__ == "__main__":
  ...
  # load map
  GeoPoint.AREA_LAT = 42.15 # the latitude of the testing area. In fact, any value is ok in this problem.
  roadnet = Map()
